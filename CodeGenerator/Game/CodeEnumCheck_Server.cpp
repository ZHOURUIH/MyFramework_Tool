...
void CodeEnumCheck_Server::doGenerate(const string& className, const string& path, const string& headerFile)
{
...
void CodeEnumCheck_Server::collectEnum(const string& fileName, myMap<string, myVector<string>>& allEnumValueList)
{
	string curEnumName;
...
void CodeEnumCheck_Server::generateEnumCheck(const myMap<string, myVector<string>>& allEnumValueList, const string& className, const string& fullPath, const string& headerFile)
{
	string header;
