...
bool CodeFrameSystem_Server::isSystemFile(const string fileName)
{
	return endWith(fileName, "System") || endWith(fileName, "Manager");
}

bool CodeFrameSystem_Server::isFrameClass(const string& className, const string& line)
{
	if (className.empty())
	{
		return false;
...
bool CodeFrameSystem_Server::isPoolFile(const string& fileName)
{
	return endWith(fileName, "Pool") || endWith(fileName, "PoolThread");
}

bool CodeFrameSystem_Server::isPoolClass(const string& line)
{
...
bool CodeFrameSystem_Server::isClassObjectPoolFile(const string& fileName)
{
...
bool CodeFrameSystem_Server::isFactoryFile(const string& fileName)
{
	return endWith(fileName, "FactoryManager") && fileName != "FactoryManager";
}

bool CodeFrameSystem_Server::isFactoryClass(const string& line)
{
	return findSubstr(line, " : public FactoryManager<");
}

void CodeFrameSystem_Server::generateFrameSystem(const string& cppPath, const string& baseFilePathNoSuffix, const string& gameFilePath, const string& baseClassName, const string& exportMacro)
{
...
void CodeFrameSystem_Server::generateFrameSystemRegister(const myVector<string>& frameSystemList, const string& gameCppPath)
{
	// 更新Game.cpp的特定部分代码
...
void CodeFrameSystem_Server::generateFrameSystemClear(const myVector<string>& frameSystemList, const string& gameBaseSourceFile)
{
...
void CodeFrameSystem_Server::generateFrameSystemDeclare(const myVector<string>& frameSystemList, const string& gameBaseHeaderFile, const string& exportMacro)
{
	// 更新GameBase.h的特定部分代码
	myVector<string> codeList;
	int lineStart = -1;
...
void CodeFrameSystem_Server::generateFrameSystemDefine(const myVector<string>& frameSystemList, const string& gameBaseSourceFile)
{
	// 更新GameBase.cpp的特定部分代码
	myVector<string> codeList;
	int lineStart = -1;
...
void CodeFrameSystem_Server::generateFrameSystemGet(const myVector<string>& frameSystemList, const string& gameBaseSourceFile)
{
	// 更新GameBase.cpp的特定部分代码
	myVector<string> codeList;
	int lineStart = -1;
