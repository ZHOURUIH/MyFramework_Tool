...
void CodeMySQL_Server::generateCppMySQLDataFile(const MySQLInfo& mysqlInfo, const string& filePath)
{
	// 头文件
	string header;
...
void CodeMySQL_Server::generateCppMySQLTableFile(const MySQLInfo& mysqlInfo, const string& filePath)
{
...
void CodeMySQL_Server::generateCppMySQLRegisteFile(const myVector<MySQLInfo>& mysqlList, const string& filePath)
{
	// MySQLRegiste.h
	string str0;
...
void CodeMySQL_Server::generateMySQLInstanceDeclare(const myVector<MySQLInfo>& mysqlList, const string& gameBaseHeaderFile, const string& exprtMacro)
{
	// 更新GameBase.h的特定部分
	myVector<string> codeList;
	int lineStart = -1;
...
void CodeMySQL_Server::generateMySQLInstanceDefine(const myVector<MySQLInfo>& mysqlList, const string& gameBaseSourceFile)
{
	// 更新GameBase.cpp的特定部分
	myVector<string> codeList;
	int lineStart = -1;
...
void CodeMySQL_Server::generateMySQLInstanceClear(const myVector<MySQLInfo>& mysqlList, const string& gameBaseSourceFile)
{
	// 更新GameBase.cpp的特定部分
	myVector<string> codeList;
	int lineStart = -1;
