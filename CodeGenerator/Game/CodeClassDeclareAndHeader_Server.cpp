...
void CodeClassDeclareAndHeader_Server::generateCppFrameClassAndHeader(const string& path, const string& targetFilePath)
{
...
void CodeClassDeclareAndHeader_Server::generateCppGameClassAndHeader(const string& path, const string& targetFilePath)
{
